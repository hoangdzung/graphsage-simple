...
def run_cora():
   ...
   # features.cuda()
    ...
    for batch in range(100):
        ...
        optimizer.zero_grad()
        embeds1,_ = graphsage.forward(nodes1)
        embeds2,_ = graphsage.forward(nodes2)
        neg_embeds,_ = graphsage.forward(neg_nodes)
        loss = graphsage.unsup_loss(embeds1, embeds2, neg_embeds)
        loss.backward()
        optimizer.step()
        end_time = time.time()
